...
# manually fixed grammar in t2t.mjs
...
cat front.part test.grammar middle.part support.js test.rwr.mjs tail.part >new.dev.test.mjs
node new.dev.test.mjs test.txt

echo
echo '*** 2 ***'
node t2t.mjs test2.rewrite >test2.rwr.mjs
cat front.part test2.grammar middle.part support.js test2.rwr.mjs tail.part >new.dev.test2.mjs
...
# echo
# echo '*** 6 ***'
# node t2t.mjs test6.rewrite >test6.rwr.mjs
# cat test6.rwr.mjs
